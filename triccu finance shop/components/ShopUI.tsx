...
export const SplashScreen = ({ onComplete }: { onComplete: () => void }) => {
  ...
  return (
    ...
    >
      <div className="absolute inset-0 bg-radial-gradient from-blue-500/20 to-transparent blur-[120px]" />
      
      <div className="absolute inset-0 z-0 opacity-80 pointer-events-none flex items-center justify-center">
        {/* Placeholder Spline ID for Shop */}
      ...
      >
        <div className="w-24 h-24 rounded-[32px] glass-card flex items-center justify-center text-white text-5xl font-black shadow-[0_0_40px_rgba(59,130,246,0.3)] mb-6 relative group border border-blue-500/30 backdrop-blur-md bg-black/40">
           <span className="relative z-10 drop-shadow-[0_0_10px_rgba(59,130,246,0.8)]">T</span>
        </div>
        <motion.h1 
        ...
        >
          TRICCU <span className="text-blue-500 not-italic font-normal">SHOP</span>
        </motion.h1>
      </motion.div>
      ...
      <div className="absolute bottom-12 flex flex-col items-center gap-2 z-10">
         <div className="flex items-center gap-2 px-4 py-2 glass-card border-white/10 rounded-full bg-black/50 backdrop-blur-md">
            ...
            <span className="text-[9px] font-bold text-white/60 uppercase tracking-widest">Merchant Portal</span>
         </div>
