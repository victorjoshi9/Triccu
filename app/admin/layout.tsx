...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  const navItems = [
    ...
    { name: 'Loans', href: '/admin/loans', icon: Briefcase },
    { name: 'Device Locks', href: '/admin/locks', icon: Lock },
    ...
    <div className="min-h-screen bg-[var(--color-surface-light)] flex">
      ...
      <aside className="w-72 border-r border-white/20 bg-white/40 backdrop-blur-3xl flex flex-col shadow-[4px_0_24px_rgba(0,0,0,0.02)] z-20">
        ...
        <div className="p-6 mt-auto">
          <button className="w-full neo-card p-4 flex items-center justify-center gap-2 font-medium hover:opacity-90 transition-opacity">
